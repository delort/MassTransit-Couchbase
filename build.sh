...
#export MONO_PATH=${PKG_DIR}/lib/mono/4.5:${PKG_DIR}/lib/mono/4.0:${PKG_DIR}/lib/mono/3.5:${PKG_DIR}/lib/mono/2.0:${PKG_DIR}/lib/mono/compat-2.0
...
#export MONO_PATH=${MONO_PATH}:${PWD}/build/FAKE/tools

mono "build\FAKE\tools\Fake.exe" build.fsx $1 --logfile build.log
